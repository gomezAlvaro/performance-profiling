...
public class LoanService {
  ...
  public synchronized LoanApplication.Status getLoanApplicationStatusForClient(Long id) {
  ...
  public void insertInitialData() {
    LoanApplication.ApprovalStep step1 = new LoanApplication.ApprovalStep().setName("Pre-Scan Client").setStatus(LoanApplication.Status.APPROVED);
    LoanApplication.ApprovalStep step2 = new LoanApplication.ApprovalStep().setName("Credit Registry").setStatus(LoanApplication.Status.DECLINED);
